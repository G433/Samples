...
namespace DJIWindowsSDKSample.Helpers
{
    public class Helper
    {
        ...
        public async Task<VideoFrame> CropAndDisplayInputImage1Async(VideoFrame inputVideoFrame)
        {
            bool useDX = inputVideoFrame.SoftwareBitmap == null;
            ...
            var vf = new VideoFrame(BitmapPixelFormat.Bgra8, 28, 28, BitmapAlphaMode.Ignore);
