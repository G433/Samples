...
namespace DJIWindowsSDKSample
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private List<SDKModuleSampleItems> navigationModules = new List<SDKModuleSampleItems>
        {
            ...
            new SDKModuleSampleItems() {
                header = "Component Handling", items = new List<KeyValuePair<String, Type>>()
                {
                    ...
                    new KeyValuePair<string, Type>("Flight Controller", typeof(ComponentHandling.FlightControllerPage)),
                    new KeyValuePair<string, Type>("Camera", typeof(ComponentHandling.Camera))
                },
            },
            new SDKModuleSampleItems() {
            ...
            new SDKModuleSampleItems() {
                header = "Battery", items = new List<KeyValuePair<String, Type>>()
                {
                    new KeyValuePair<string, Type>("Battery", typeof(Battery.BatteryPage)),
                },
            },
        };
        ...
        public MainPage()
        {
            ...
            DJISDKManager.Instance.RegisterApp("1cd66d4cad23438927b1e980");
        }
